                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('permission.update',$permission->id) }}" method="POST"
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" value="{{$permission->name}}" placeholder="Enter product name" required>
                            @error('name')
