            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('role.store') }}" method="POST" class="space-y-6">
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="bg-transparent hover:bg-neutral-500 text-neutral-700 font-semibold hover:text-white py-2 px-4 border border-neutral-500 hover:border-transparent rounded"> Save</button>
                    </form>
